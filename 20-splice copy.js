...
function splice(array, start, deleteCount) {
	...
	// var numberOfElementsToReplace  = deleteCount - elementsToAdd;

	// var finalArrayLength = (array.length + numberOfElementsToAdd - numberOfElementsToDelete) || 0;	//!

	//start index = 2
	//deleteCount = 1, number of elements to delete

	// for (var i = start; i < array.length; i++) {
	// 	spliceResult[spliceResultIndex] = array[i];
	// 	spliceResultIndex++;

	// 	// if any element to add - add
	// 	if(elementsToAdd > 0) {
	// 		array[i] = arguments[elementsToAddIndex];
	// 		elementsToAddIndex++;
	// 		elementsToAdd--;
	// 		deleteCount--;
	// 	} else {
	...
	// 	//delete element for array-like object
	// 	if(deleteCount > 0) {
	// 		spliceResult[spliceResultIndex] = array[i];
	// 		spliceResultIndex++;
	...
	// 		}
	// 		else if (finalArrayLength !== array.length) {
	// 			array[i - 1] = array[i];
	// 		}
	// }

	// }
	// if(array.length !== finalArrayLength) {
	...
	if(deleteCount > items) {
		...
		array.length = array.length - items;
	}
