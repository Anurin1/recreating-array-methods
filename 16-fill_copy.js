...
tests({
	...
	'If start is negative, and the calculation of (array.length + start) is smaller than 0, the begin should be equal to 0.': function() {
		var originalArray = [1, 1, 1];
	...
	'If end is negative, and the calculation of (array.length + end) is smaller than 0, the begin should be equal to 0.': function() {
		var originalArray = [1, 1, 1];
